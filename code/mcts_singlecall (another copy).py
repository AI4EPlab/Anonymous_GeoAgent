    ...
    while tasks:
        ...
        for i in range(max_rollouts):
            ...
            if tokens:
                for idx, (token, prob) in enumerate(zip(tokens, probs)):
                    ...
                    reward = calculate_reward(curr_node.task + curr_node.label, token)
                ...
                completion = beam_search(curr_node, '')
        ...
        if reward != 1:
            ...
            for graph_id, graph_data in graph_dict.items():
                ...
                graph_success_len = graph_data["reward"]
        ...
        if max_completion and (max_reward < max_success_len):
            best_completion = max_completion
