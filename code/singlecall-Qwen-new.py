...
def main():
    ...
    task_path = '/workspace/comparison_bench/GeoCode_Other_selected.jsonl'
    # this is for cibench
    #exec_path_root = '/workspace/comparison_bench/sequential_task/'
    exec_path_root = '/workspace/comparison_bench/GeoSpatial2task'
    output_doc = '/workspace/comparison_bench/sequential_task/GeoCode_Other_selected_single.jsonl'
