...
model_name_path = '/workspace/codegemma-7b-it'
model_name = 'unsloth/codegemma-7b-it'
...
def main():
    ...
    task_path = '/workspace/comparison_bench/odex-exec.jsonl'
    # this is for cibench
    exec_path_root = '/workspace/comparison_bench/sequential_task/'
    # exec_path_root = '/workspace/comparison_bench/GeoSpatial2task'
    output_doc = '/workspace/comparison_bench/sequential_task/odex-exec_single.jsonl'
